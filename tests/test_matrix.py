...
class TestMatrix(unittest.TestCase):
    ...
    def testMatrixInit(self):
        ...
        self.assertEquals(matrix.M[(1, 3, 7)], 2.0)
        self.assertEquals(matrix.M[(0, 0, 0)], 2.0)
        self.assertEquals(matrix.M[(0, 0, 2)], 2.0)
        self.assertEquals(matrix.M[(1, 1, 5)], 7.0)
        self.assertEquals(matrix.M[(1, 1, 3)], 3.0)
        self.assertEquals(matrix.M[(1, 3, 6)], 2.0)
        self.assertEquals(matrix.M[(1, 3, 8)], 2.0)
        self.assertEquals(matrix.M[(0, 0, 1)], 2.0)
        self.assertEquals(matrix.M[(1, 1, 4)], 2.0)
        self.assertEquals(matrix.M[(1, 2, 5)], 2.0)
